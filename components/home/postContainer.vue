<template lang="">
  <div id="post_preference" class="w-full border-r border-gray-600 text-white">
      ...
      <div class="flex font-semibold tracking-wide">
        ...
        >
          <span
            class="p-3 w-full font-system"
            :class="{
              'border-b-4 border-sky-500': activeShowFollowedPosts,
            }"
            >Following</span
          >
        </div>
    ...
    <HomeCreatePostContainer v-if="activeShowAllPosts" />
    <!-- Posts Container -->
    <div id="post-container">
      <!-- All posts container -->
      <div id="allPosts">
        <HomePosts v-if="activeShowAllPosts"> </HomePosts>
        <div id="followposts" v-if="activeShowFollowedPosts" class="">
          <div
