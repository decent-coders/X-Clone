<template>
  <div
    class="bg-black -ml-14 w-[47%] rounded-lg border shadow-[rgba(233,233,233,.4)_0px_0px_15px_3px] border-gray-600 p-4"
  >
    <slot></slot>
    <div class="flex p-4 border-gray-600">
      <div id="ppImage" class="w-14 h-full">
        <img class="h-14 w-14 rounded-full" src="/public/me.webp" alt="" />
      </div>
      <div class="flex-1">
